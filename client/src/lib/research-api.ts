...
export const API_URL = typeof window !== 'undefined' 
  ? (window.location.hostname === 'localhost' ? 'https://chatbot-z6w5.onrender.com/api' : `${window.location.origin}/api`)
  : (process.env.NEXT_PUBLIC_API_URL || 'https://chatbot-z6w5.onrender.com/api');
